...
import top.iot.gateway.rule.engine.api.*;
...
import top.iot.gateway.rule.engine.api.Logger;
...
public interface ExecutionContext {
    ...
    /**
     * 触发error,此方法永远返回{@link Mono#empty()},此操作也会触发{@link RuleConstants.Event#error}事件
     *
     * @param e          异常信息
